...
namespace SharedTripSystem.Migrations
{
    ...
    [Migration("20210809123430_PassengerTripTable")]
    partial class PassengerTripTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharedTripSystem.Data.Models.Passenger", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SharedTripSystem.Data.Models.PassengerTrip", b =>
                {
            ...
            modelBuilder.Entity("SharedTripSystem.Data.Models.Recommendation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SharedTripSystem.Data.Models.Passenger", b =>
                {
                    b.HasOne("SharedTripSystem.Data.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SharedTripSystem.Data.Models.PassengerTrip", b =>
                {
                    b.HasOne("SharedTripSystem.Data.Models.Passenger", "Passenger")
